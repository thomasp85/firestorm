...
## Example
Below you can see an example of using firestorm with a fiery server. Here we
relay all requests to the fiery server to another service running on the same
computer.
